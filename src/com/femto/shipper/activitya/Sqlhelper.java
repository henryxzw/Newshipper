...
public class Sqlhelper extends SQLiteOpenHelper {
	...
	private final static String sqlname = "sslid.db";
	private final static String tablename = "sslid";
	...
	public void onCreate(SQLiteDatabase arg0) {
		arg0.execSQL("create table "
				+ tablename
				+ "( _id integer primary key autoincrement,name text,address text,la text,lo text)");
	}
	...
	public void insert(String name, String address, String la, String lo) {
		...
		db.execSQL("insert into " + tablename
				+ "(name,address,la,lo) values(?,?,?,?)", new String[] { name,
				address, la, lo });
	}
