...
public class Mydialogf extends Activity implements OnClickListener {
	...
	private int[] imgid = new int[] { R.drawable.glpbz, R.drawable.glpb3,
			R.drawable.glpb5, R.drawable.glpb8, R.drawable.glpb15 };
	...
	private String dwzw = "null", gg = "null", qbj = "null", ccj = "null",
			...
			xhdd;
	private int djcsa = 0, clsl, carid = 36, maxsize = 24, minsize = 14,
			msychsyuyc;
	...
	@SuppressWarnings("rawtypes")
	public Mydialogf(Context con, String zhlat, String zhlon, String xhlat,
	...
	public void onClick(View arg0) {
		...
		case R.id.mdldbtn:
			if (djcsa == 0) {
				...
				dialogcallbackf.dialogdof(qcmz, dwzw, gg, xhsl, qbj, ccj,
						carid, zhl);
				dismiss();
			}
			break;
	...
	private void mypaintaccxz(int m) {
		...
		mypaintaccxz.addChangingListener(new OnWheelChangedListener() {
			...
			public void onChanged(WheelView wheel, int oldValue, int newValue) {
				...
				// mdldtvzdzzl.setText(zdzzl[2]);
				// mdldtvqbjg.setText(qbjg[7]);
				// mdldtvccjg.setText(ccjg[7]);
				//
				// }
				// if (text.equals(cc[5])) {
				...
				// } else {
				// carid = 93;
				// mdldtvqbjg.setText(qbjg[10]);
				// mdldtvccjg.setText(ccjg[10]);
				// }
				...
				// if (jqdwb.trim().equals("8")) {
				// carid = 91;
				// mdldtvqbjg.setText(qbjg[8]);
				// mdldtvccjg.setText(ccjg[8]);
				// } else {
				// carid = 80;
				// mdldtvqbjg.setText(qbjg[5]);
				...
				// if (jqdwb.trim().equals("8")) {
				// carid = 92;
				// mdldtvqbjg.setText(qbjg[9]);
				// mdldtvccjg.setText(ccjg[9]);
				// } else {
				// carid = 94;
				// mdldtvqbjg.setText(qbjg[11]);
				// mdldtvccjg.setText(ccjg[11]);
				// }
