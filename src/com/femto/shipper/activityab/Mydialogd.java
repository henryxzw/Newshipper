...
public class Mydialogd extends Activity implements OnClickListener {
	...
	private int[] imgid = new int[] { R.drawable.xsz, R.drawable.xsz3,
			R.drawable.xsz5, R.drawable.xsz8, R.drawable.xsz15 };
	...
	private String dwzw = "null", gg = "null", qbj = "null", ccj = "null",
			...
			xhdd;
	private int djcsa = 0, clsl, carid = 40, maxsize = 24, minsize = 14,
			msychsyuyc;
	...
	@SuppressWarnings("rawtypes")
	public Mydialogd(Context con, String zhlat, String zhlon, String xhlat,
	...
	public void onClick(View arg0) {
		...
		case R.id.mdldbtn:
			if (djcsa == 0) {
				...
				dialogcallbackd.dialogdod(qcmz, dwzw, gg, xhsl, qbj, ccj,
						carid, zhl);
				dismiss();
			}
			break;
